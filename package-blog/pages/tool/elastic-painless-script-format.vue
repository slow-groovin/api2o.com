          ...
          <h1 class="text-2xl font-bold">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"
              ...
              <g class="">
                ...
                <path d="M6 11 L12 12 L13 5 C13 5 12 4 11 4 C8 4 6 7 6 9 C6 10 6 10 6 11 Z" fill="#EF5098"
                      class=""></path>
                <path d="M6 12 C3 13 1 16 1 19 C1 21 3 24 5 25 L14 17 L12 14 L6 12 Z" fill="#1BA9F5"
                      class=""></path>
                <path d="M26 34 C27 34 28 35 29 35 C31 35 30 33 33 29 C33 29 33 28 33 28 L27 27 L26 34 Z" fill="#93883E"
                      class=""></path>
                <path d="M27 25 L34 27 C36 12 38 23 38 20 C38 18 36 15 34 14 L25 22 L27 25 Z" fill="#0077CC"
                      class=""></path>
              </g>
            </svg>
...
<!--            <UncompletedBadge/>-->
        ...
        <div class="p-6 border-y-4 border-[#FED10A]">
          <div class="flex flex-row  items-center">
            ...
            <div class="font-light ">
              Input Sample:
              <span v-for="(link,index) in sampleScripts"
                    class="ml-1 underline text-blue-500 cursor-pointer"
        ...
        <div class="p-6 border-y-4 border-primary mb-4">
          ...
          <textarea
              id="output-code"
              class="focus:outline-none focus:border-blue-500 w-full px-3 py-2  border rounded-lg"
              v-model="multiLineCode"
              rows="8"
              :placeholder="i18nVal('placeholder')"/>
...
function one2multi(oneLineCode: string) {
  console.log(js_beautify(oneLineCode, {
    indent_size:2
  }));
  return js_beautify(oneLineCode.replace(/\\"/g, '"'), {})
}
