...
<template>
  <svg  viewBox="0 0 400 400" :class="cn('w-4 h-4 fill-current',props.class)" aria-label="GraphQL">
    ...
    <path d="M342.568 302.663l-160.15-277.38 14.376-8.3 160.15 277.38zM52.5 107.5h16.6v185H52.5z" />
